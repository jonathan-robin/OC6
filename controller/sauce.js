...
exports.rateSauce = (req, res, next) => {
    switch (req.body.like){ // switch over the number passed
        ...
        case -1: // -1 mean add 1 dislike
            ...
            return Sauce.updateOne({ _id: req.params.id },{ $inc: {dislikes: req.body.like++*-1}, $push: {usersDisliked: req.body.userId}}).then(res.status(200).json('+1 dislike')).catch(error => json({ error }))
